...
',
  ...
  array (
    ...
    'New product' => 'Producto nuevo',
    'Caption' => 'Leyenda',
    '[1]%filesNb%[/1] selected file(s)' => '[1]%filesNb%[/1] archivo(s) seleccionado(s)',
...
Una vez actives la opción "%generate_rtl_label%", cualquier archivo específico RTL que hayas añadido al tema podría ser eliminado por la hoja de estilo creada.',
  ...
  array (
    ...
    'This module is not compatible with the multistore feature. It means that its configuration applies to all stores.' => 'Este módulo no es compatible con la funcionalidad multitienda. Esto significa que su configuración aplica a todas las tiendas. ',
  ...
  array (
    ...
    'Profile(s) assigned to employee cannot be deleted' => 'Un perfil asignado a un empleado no puede ser eliminado',
